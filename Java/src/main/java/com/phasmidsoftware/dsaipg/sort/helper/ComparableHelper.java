...
//        return pureComparison(v, w);
    ...
    /**
     * Provides a comparator for comparing elements of type X.
     *
     * @return a Comparator instance that uses the compareTo method of the Comparable interface for comparing elements.
     */
