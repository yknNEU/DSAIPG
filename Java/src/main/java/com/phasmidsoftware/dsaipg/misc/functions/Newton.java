...
public class Newton {
    ...
    /**
     * The main method to demonstrate solving a mathematical problem using Newton's method.
     * It creates an instance of the Newton class to solve the equation cos(x) = x,
     * applies the Newton-Raphson approach to find the root, and processes the result.
     *
    ...
    /**
     * Represents the equation that is the basis of the mathematical problem to be solved using Newton's method.
     * The equation is stored as a string and is expected to define a mathematical function of the form `f(x)`.
     * The actual problem solved is finding the root of this equation such that `f(x) = 0`.
     */
    private final String equation;
    /**
     * Represents a mathematical function f(x) defined as a {@link DoubleFunction}
     * that takes a double precision input and produces a double precision output.
     * This function is central to solving mathematical problems using Newton's method,
     * where it is used to find the roots of the equation f(x) = 0.
     */
    private final DoubleFunction<Double> f;
    /**
     * Represents the first derivative of the function f(x) with respect to the variable x.
     * This is a mathematical function defined as a DoubleFunction<Double>, which means it takes
     * a single double value (x) as input and produces a double result (the derivative value at x).
     * <p>
     * Used within the Newton class to perform calculations related to Newton's method for root-finding.
     */
