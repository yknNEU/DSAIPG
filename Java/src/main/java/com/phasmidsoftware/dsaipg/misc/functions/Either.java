...
public final class Either<L, R> {
    ...
    /**
     * Represents the left value in an `Either` structure.
     * This is an optional value, meaning it may or may not be present.
     * The left value typically signifies an alternative or "error" case,
     * depending on the usage context of the `Either` class.
     *
    ...
    /**
     * Represents the optional right value of this `Either` instance.
     * If present, this value contains the right-hand side of the choice in the `Either` structure,
     * which is contrasted with the left-hand side represented by the `left` field.
     * The right value, if present, indicates a successful or desired outcome depending on the context.
