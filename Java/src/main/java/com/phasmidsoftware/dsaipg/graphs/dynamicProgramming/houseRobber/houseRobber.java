...
/**
 * The {@code houseRobber} class provides methods to solve the problem of
 * maximizing the profit a robber can achieve by selecting specific houses
 * while adhering to constraints that no two consecutive houses can be robbed.
 * <p>
 * This implementation uses graph construction to represent all possible
 * combinations of houses that can be robbed and the Bellman-Ford algorithm
