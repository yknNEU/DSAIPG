...
import com.phasmidsoftware.dsaipg.graphs.undirected.Graph;
...
/**
 * This class constructs a minimum spanning tree of tunnels connecting a collection of buildings
 * using the Boruvka's algorithm. It leverages geospatial properties and constraints such as
 * tunnel costs, lengths, and zoning regulations to generate the most efficient network of connections within a set of buildings.
 * The output data includes the total cost and length of the tunnels, and can be visualized using a KML file.
 * It allows iteration over all edges in the resulting minimum spanning tree.
 */
public class Tunnels_Boruvka implements Iterable<Edge<Building, TunnelProperties>> {

    /**
     * Retrieves the Minimum Spanning Tree (MST) of the graph constructed from the buildings and tunnels.
     * The MST represents a subset of edges connecting all vertices (buildings) with the minimum total edge weight,
     * without any cycles.
     *
     * @return the graph representing the Minimum Spanning Tree, where the vertices are instances of
     * {@code Building} and the edges are instances of {@code Edge<Building, TunnelProperties>}.
     */
    ...
    /**
     * The main method serves as the entry point for the computation of the Minimum Spanning Tree (MST)
     * of buildings and their interconnecting tunnels. It calculates the total cost and length of the tunnels,
     * generates a KML file to visualize the spanning tree, and prints the relevant details to standard output.
     *
     * @param args Command-line arguments passed to the program.
     *             This method does not utilize the command-line arguments.
     * @throws IOException If an error occurs during file creation or writing the KML output.
     */
    public static void main(String[] args) throws IOException {
        ...
        for (Edge<Building, TunnelProperties> e : mst.geoEdges()) {
    ...
    /**
     * Constructs a Tunnels_Boruvka instance to compute the Minimum Spanning Tree (MST)
     * of a set of buildings connected by tunnels. Initializes zones and tunnel data,
     * then applies Boruvka's algorithm with a constraint on the maximum tunnel length.
     *
     * @param buildings a list of {@code Building} objects representing the structures
     *                  to be connected through tunnels.
     */
    ...
    private com.phasmidsoftware.dsaipg.graphs.gis.Boruvka<Building, TunnelProperties> getBoruvka() {
        return Boruvka;
    }
