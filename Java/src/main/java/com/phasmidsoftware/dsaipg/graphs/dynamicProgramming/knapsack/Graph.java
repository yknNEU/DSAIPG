...
/**
 * The {@code Graph} class represents a directed graph.
 * It supports adding vertices, adding edges between vertices,
 * and provides access to various graph properties such as the number
 * of vertices, the number of edges, and adjacency relationships.
 *
 * The graph is represented using an adjacency list, where each
 * vertex is associated with a list of its adjacent edges.
 *
