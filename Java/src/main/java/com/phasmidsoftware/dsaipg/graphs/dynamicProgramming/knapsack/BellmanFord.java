...
/**
 * The BellmanFord class provides a method to implement the Bellman-Ford algorithm
 * that calculates the shortest path in a graph from a source vertex to a target vertex.
 * It handles graphs with weighted edges, including those with negative weights.
 *
