...
import com.phasmidsoftware.dsaipg.graphs.traversal.Bag;
import com.phasmidsoftware.dsaipg.graphs.traversal.StdRandom;
...
public class EdgeWeightedDigraph {
    ...
    /**
     * Validates that the given vertex index is within the valid range for the graph.
     * Throws an {@code IllegalArgumentException} if the index is not between 0 (inclusive)
     * and the total number of vertices {@code V} (exclusive).
     *
     * @param v the vertex index to be validated
     * @throws IllegalArgumentException if {@code v} is not between 0 and {@code V - 1}
     */
