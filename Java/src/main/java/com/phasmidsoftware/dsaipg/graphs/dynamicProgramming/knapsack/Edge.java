...
/**
 * The {@code Edge} class represents an edge in a graph.
 * An edge connects two vertices (source and destination)
 * and has an associated weight which typically represents
