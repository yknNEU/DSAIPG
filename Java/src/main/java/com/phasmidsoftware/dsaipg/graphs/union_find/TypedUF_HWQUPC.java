...
public class TypedUF_HWQUPC<T> extends UF_HWQUPC implements TypedUF<T> {
    ...
    /**
     * A private map that associates elements of type T with their corresponding integer indices.
     * This map is used internally by the union-find structure to efficiently manage and
     * perform operations on the components. Each unique element in the union-find structure
     * is assigned a unique integer index stored in this map.
     */
